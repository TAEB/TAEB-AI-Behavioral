...
my @tests = (
    ...
    ["k - an uncursed spellbook of cure sickness",      {class => "book"}  ],
    ["m - an uncursed spellbook of detect unseen",      {class => "book"}  ],
    ["T - the uncursed Book of the Dead",               {class => "book"}  ],
    ["C - an uncursed potion of restore ability",       {class => "potion"}],
    ["Q - an uncursed potion of speed",                 {class => "potion"}],
