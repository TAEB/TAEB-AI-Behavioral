...
my @tests = (
    ["a - a +1 club",
     {is_greased => 0, is_poisoned => 0, erosion1 => 0, erosion2 => 0,
      is_fooproof => 0, is_diluted => 0, partly_used => 0}],
    ...
    ["f - an uncursed diluted potion of monster detection",
     {is_greased => 0, is_poisoned => 0, erosion1 => 0, erosion2 => 0,
      is_fooproof => 0, is_diluted => 1, partly_used => 0}],
);
