...
my @tests = (
    ["a - a +1 long sword (weapon in hand)",
     {recharges => undef, charges => undef, candles_attached => 0,
      is_lit => 0, is_quivered => 0, is_offhand => 0,
      is_wielding => 1, is_wearing => 0,
    ...
    ["f - a long sword (alternate weapon; not wielded)",
     {recharges => undef, charges => undef, candles_attached => 0,
      is_lit => 0, is_quivered => 0, is_offhand => 1,
      is_wielding => 0, is_wearing => 0,
      is_laid_by_you => 0, is_chained_to_you => 0}],
    ["g - 2 darts (in quiver)",
     {recharges => undef, charges => undef, candles_attached => 0,
      is_lit => 0, is_quivered => 1, is_offhand => 0,
      is_wielding => 0, is_wearing => 0,
      is_laid_by_you => 0, is_chained_to_you => 0}],
    ["e - an uncursed oil lamp (lit)",
     {recharges => undef, charges => undef, candles_attached => 0,
      is_lit => 1, is_quivered => 0, is_offhand => 0,
      is_wielding => 0, is_wearing => 0,
      is_laid_by_you => 0, is_chained_to_you => 0}],
